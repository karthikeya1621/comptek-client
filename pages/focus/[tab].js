...
export default function FocusTab() {
    ...
    return <div className={styles.FocusPage}>
        ...
        {/* Industrial */}
        {tab == 'industrial' && data ? <div className={styles.Industrial}>
            <div className="w-full relative">
                <div className="absolute w-[70%] h-full right-10">
                    <Image layout="fill" objectFit="contain" objectPosition="center" src={data?.content[0].image.data.attributes.url} />
                </div>
                <div className="contentContainer flex items-center bg-white-100" style={{ minHeight: '400px' }}>
                    <div className={styles.ContentOne}>
                        ...
                        <span className="BrandDot"></span>
                        <h5>01</h5>
                        <p dangerouslySetInnerHTML={{ __html: data?.content[0].para }}></p>
                    </div>
                </div>
            </div>
            <div className="w-full relative bg-brand text-white">
                ...
                <div className="contentContainer">
                    <div className="grid grid-cols-2 py-6">
                        <div className="col-sapn-1 flex items-center" dangerouslySetInnerHTML={{ __html: data?.content[1].para }}>

                        </div>
                        <div className="col-sapn-1 flex justify-end">
                            <div className="relative z-10 top-10 shadow-md"><Image width={300} height={240} src={data?.content[1].image.data.attributes.url} /></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="contentContainer">
                    <div className="grid grid-cols-2 py-10">
                        <div className="col-span-1 py-6 flex justify-center items-center">
                            <div className="shadow"><Image width={340} height={260} objectFit="cover" src={data?.content[2].image.data.attributes.url} /></div>
                        </div>
                        <div className="col-span-1 py-6 flex items-center">
                            <div className={styles.ContentTwo}><p dangerouslySetInnerHTML={{ __html: data?.content[2].para }}></p><h5>02</h5></div>
                        </div>
                        <div className="col-span-1 py-6 flex items-center">
                            <div className={styles.ContentTwo} dangerouslySetInnerHTML={{ __html: data?.content[3].para }}></div>
                        </div>
                        <div className="col-span-1 py-6 flex justify-center items-center">
                            <div className="shadow"><Image width={340} height={260} objectFit="cover" src={data?.content[3].image.data.attributes.url} /></div>
                        </div>
                        <div className="col-span-1 py-6 flex justify-center items-center">
                            <div className="shadow"><Image width={340} height={260} objectFit="cover" src={data?.content[4].image.data.attributes.url} /></div>
                        </div>
                        <div className="col-span-1 py-6 flex items-center">
                            <div className={styles.ContentTwo} dangerouslySetInnerHTML={{ __html: data?.content[4].para }}></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="contentContainer py-6">
                    ...
                    <div className="grid grid-cols-2 px-12 py-8 bg-white rounded shadow-xl mb-6">
                        <div className="col-span-1 relative h-full text-sm flex items-center">
                            <p dangerouslySetInnerHTML={{ __html: data?.qualityProgram?.content }}></p>
                        </div>
                        <div className="col-span-1 relative h-full flex items-center justify-center">
                            {data?.qualityProgram?.badges.map((badge, bi) => <div key={`badge${bi}`} className="flex flex-col text-center text-sm mx-3">
